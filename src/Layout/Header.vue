...
<template>
  <div>
    <!-- Header -->
    <header
      class="mx-auto flex w-full h-20 max-w-[1200px] items-center justify-between px-5"
    >
      <routerLink :to="{ name: 'Home' }">
        <img
          class="cursor-pointer sm:h-auto sm:w-auto"
          src="https://icms-image.slatic.net/images/ims-web/0740e843-2bd9-4626-bdbe-674d8198d0a0.png"
          alt="company logo"
          style="height: 70px"
        />
      </routerLink>
      ...
      <form
        class="hidden h-12 w-3/5 items-center border md:flex"
        @submit.prevent=""
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          class="ml-auto h-full bg-orange-600 px-4 hover:bg-orange-700 text-white"
        >
          Search
        </button>
      </form>
      ...
      <div class="hidden gap-3 md:!flex">
        <RouterLink :to="{ name: 'Wishlist' }"
          ><a class="flex cursor-pointer flex-col items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
